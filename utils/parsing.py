...
def parse_train_args():
    ...
    parser.add_argument('--res_tr_weight', type=float, default=0.33, help='Weight of residue translation loss')
    parser.add_argument('--res_rot_weight', type=float, default=0.33, help='Weight of residue rotation loss')
    parser.add_argument('--res_chi_weight', type=float, default=0.33, help='Weight of residue rotation loss')
    ...
    parser.add_argument('--scale_by_sigma', action='store_true', default=False, help='Whether to normalise the score')
